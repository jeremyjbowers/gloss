 ...
 * @constructor
 */
annotorious.plugin.BlurBoxSelector = function(config_opts) { 
  if (config_opts)
 ...
 */
annotorious.plugin.BlurBoxSelector.prototype.onInitAnnotator = function(annotator) {
  annotator.addSelector(new annotorious.plugin.BlurBoxSelector.Selector());
  if (this._activate)
    annotator.setCurrentSelector('blurbox');
}
 ...
 * @constructor
 */
annotorious.plugin.BlurBoxSelector.Selector = function() { }
 ...
 */
annotorious.plugin.BlurBoxSelector.Selector.prototype.init = function(annotator, canvas) {
  /** @private **/
  this._canvas = canvas;
 ...
 * @private
 */
annotorious.plugin.BlurBoxSelector.Selector.prototype._attachListeners = function() {
  var self = this;  
  this._mouseMoveListener = this._canvas.addEventListener('mousemove', function(event) {
    if (self._enabled) {
      ...
      self._g2d.fillStyle = 'rgba(0,0,0,.45)';
 ...
 * @private
 */
annotorious.plugin.BlurBoxSelector.Selector.prototype._detachListeners = function() {
 ...
 */
annotorious.plugin.BlurBoxSelector.Selector.prototype.getName = function() {
  return 'blurbox';
}
 ...
 */
annotorious.plugin.BlurBoxSelector.Selector.prototype.getSupportedShapeType = function() {
  return 'rect';
}
 ...
 */
annotorious.plugin.BlurBoxSelector.Selector.prototype.startSelection = function(x, y) {
  this._enabled = true;
 ...
 */
annotorious.plugin.BlurBoxSelector.Selector.prototype.stopSelection = function() {
 ...
 */
annotorious.plugin.BlurBoxSelector.Selector.prototype.getShape = function() {
  if (this._opposite && 
 ...
 */
annotorious.plugin.BlurBoxSelector.Selector.prototype.getViewportBounds = function() {
  var right, left;
...
annotorious.plugin.BlurBoxSelector.Selector.prototype.drawShape = function(g2d, shape, highlight) {
  if (shape.type == 'rect') {
    var color, lineWidth;
    if (highlight) {
      color = '#fff000';
